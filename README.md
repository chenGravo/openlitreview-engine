...
- 模型：DeepSeek V4 Flash 负责检索词扩展和逐篇证据提取；Kimi K2.6 负责跨证据视角梳理、提纲、正文与成稿复核。Kimi 复核属于同模型复核，私人审计中不会标作独立盲审。豆包不在默认工作路线中。
- 预算：每篇 Kimi 最多 20 元、DeepSeek 最多 15 元；同一篇断点续跑共享额度。账户月度总额 90 元预警、99 元内部停止，并保留至 100 元的外部硬边界。
