...
MODEL_PRICES: dict[str, ModelPrice] = {
    "deepseek-v4-flash": ModelPrice(
        ...
        output_cny_per_million=Decimal("3"),
    ...
    "deepseek-v4-pro": ModelPrice(
        ...
        input_cny_per_million=Decimal("4"),
        output_cny_per_million=Decimal("7"),
        effective_date="2026-08-27",
        source_url="https://api-docs.deepseek.com/quick_start/pricing",
    ),
    "kimi-k2.6": ModelPrice(
        ...
        provider="kimi",
        api_model="kimi-k2.6",
        input_cny_per_million=Decimal("8"),
        output_cny_per_million=Decimal("32"),
    ...
    "kimi-k3": ModelPrice(
        ...
        provider="kimi",
        api_model="kimi-k3",
        input_cny_per_million=Decimal("24"),
        output_cny_per_million=Decimal("120"),
        effective_date="2026-08-25",
